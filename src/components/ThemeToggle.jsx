...
const ThemeToggle = () => {
    ...
    return (
        <div className="flex justify-center items-center bg-accent-100 rounded-full">
            <input
                type="checkbox"
                id="light-switch"
            ...
            <label className="relative cursor-pointer p-2" htmlFor="light-switch">
                {/* Light theme Icon */ }
                <svg className={ theme === "dark" ? "hidden dark:block" : "dark:hidden" } width="16" height="16" xmlns="http://www.w3.org/2000/svg">
                ...
                {/* Dark theme Icon */ }
                <svg className={ theme === "dark" ? "dark:hidden" : "hidden dark:block" } width="16" height="16" xmlns="http://www.w3.org/2000/svg">
